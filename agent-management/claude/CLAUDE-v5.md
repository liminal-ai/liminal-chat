...
<execution-rules>
**Always Execute**:
- Check @claude-scratchpad/current/ before starting work
...
## Information Hierarchy
1. @claude-scratchpad/current/ - Active working memory
...
**Location**: Argus reports saved to `@agent-scratchpad/argus-qa-reports/latest.md`
...
**Response Protocol**: 
1. Read complete `@agent-scratchpad/argus-qa-reports/latest.md`
